...
# def test_breadcrumb_tracking(sample_xdp, sample_mapping_file):
#     parser = XDPParser(sample_xdp, sample_mapping_file)
#     parser.add_breadcrumb("subform")
#     assert parser.get_breadcrumb() == "<subform>", "Breadcrumb should track elements"
#     parser.remove_breadcrumb("subform")
#     assert parser.get_breadcrumb() == "", "Breadcrumb should be removed"

# # Test next_id generation
# def test_next_id(sample_xdp, sample_mapping_file):
#     parser = XDPParser(sample_xdp, sample_mapping_file)
#     first_id = parser.next_id()
#     second_id = parser.next_id()
#     assert first_id != second_id, "Each ID should be unique"

# # Test finding mapping for path
# def test_find_mapping_for_path(sample_xdp, sample_mapping_file):
#     parser = XDPParser(sample_xdp, sample_mapping_file)
#     mapping = parser.find_mapping_for_path("TestForm/TestField")
#     assert mapping is None or isinstance(mapping, dict), "Should return None or a valid mapping"
