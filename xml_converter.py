...
class XDPParser:
    def __init__(self, file_path, mapping_file='new_mapping.json'):
...
def parse_xdp_to_json(file_path, mapping_file='new_mapping.json'):
...
if __name__ == "__main__":
    ...
    result = parse_xdp_to_json(file_path, 'new_mapping.json')
